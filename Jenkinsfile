...
properties([
    parameters([
        ...
        string(name: 'EXISTING_VNET_RG_NAME', defaultValue: '', description: 'Name of the core-infra-* resouce group for the existing VNET to deploy to. EG. core-infra-sandbox'),
        string(name: 'EXISTING_VNET_NAME', defaultValue: '', description: 'Name of the existing core-infra-net-* VNET to deploy to. EG. core-infra-vnet-sandbox'),
